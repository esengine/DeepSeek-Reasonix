...
export const zhCN: TranslationSchema = {
  ...
  ui: {
    ...
    labelAHint: "左侧面板的标签",
    labelBHint: "右侧面板的标签",
    mcpListDescription: "列出发现的 MCP 服务器及其工具",
    mcpInspectDescription: "检查 MCP 服务器规格（工具、资源、提示）",
    jsonHintCatalog: "以 JSON 格式输出目录",
  ...
  slash: {
    ...
    "prune-sessions": {
      description: "删除空闲 ≥N 天的会话（默认 90）— 释放长期安装的磁盘空间",
      argsHint: "[days]",
    },
  ...
  handlers: {
    ...
    sessions: {
      ...
      pruneUsage: "▸ 用法：/prune-sessions [days]   — 默认 {default}，必须 ≥1",
      pruneNone: "▸ 无需修剪 — 没有空闲 ≥{days} 天的会话",
      pruneInfo: "▸ 已修剪 {count} 个空闲 ≥{days} 天的会话：{names}",
