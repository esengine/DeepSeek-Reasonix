...
export const zhCN: TranslationSchema = {
  ...
  slash: {
    ...
    feishu: {
      description: "连接、查看或断开当前会话的飞书通道（首次连接会引导录入 App ID / App Secret）",
  ...
  handlers: {
    ...
    feishu: {
      ...
      usage: "用法：/feishu connect [appId appSecret] | /feishu status | /feishu disconnect",
      ...
      credentialsRequired: "飞书 App ID 和 App Secret 不能为空。",
      ...
      runtimeBound:
        "飞书已在本次运行中临时绑定到首个发送者 {openid}。如需持久化，请在配置中设置 `feishu.ownerOpenId`。",
