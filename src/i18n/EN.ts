...
export const EN: TranslationSchema = {
  ...
  cardLabels: {
    ...
    earlierLine: "⋮ {count} earlier line (Ctrl+R to expand)",
    earlierLines: "⋮ {count} earlier lines (Ctrl+R to expand)",
    earlierLinesFailed: "⋮ {count} lines hidden · exit {code} (Ctrl+R to expand)",
