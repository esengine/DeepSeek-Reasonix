...
export const de: TranslationSchema = {
  ...
  slash: {
    ...
    skill: {
      ...EN.slash.skill,
      description:
        "Benutzer-Skills auflisten / ausführen / aktivieren / deaktivieren (Projekt + benutzerdefiniert + global + builtin)",
    },
    hooks: {
      ...EN.slash.hooks,
      argsHint: "[Neu laden]",
  ...
  handlers: {
    ...
    skill: {
      ...
      enableUsage: "Verwendung: /skill enable <name>",
      disableUsage: "Verwendung: /skill disable <name>",
      enabled: "▸ {name} wieder aktiviert — wird bei nächstem /new oder neuer Sitzung wirksam.",
      disabled: "▸ {name} deaktiviert — wird bei nächstem /new oder neuer Sitzung wirksam.",
      disabledHeader: "Deaktivierte Skills ({count}):",
    },
  },
  statusBar: {
    ...EN.statusBar,
