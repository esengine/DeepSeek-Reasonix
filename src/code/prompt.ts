...
- Run generated scripts from the workspace root unless you intentionally wrote them elsewhere. Do not \`cd\` into input or data directories just because the task reads files there; pass data paths as arguments.
