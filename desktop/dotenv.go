...
// credentialsPath is the qiaotongagent-owned global secrets file the settings panel
// writes API keys to — the same file `qiaotongagent setup` writes and config.loadDotEnv
