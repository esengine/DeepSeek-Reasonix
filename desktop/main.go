...
func main() {
	...
	// SSH_ASKPASS helper. Handle that capability before config migration,
	// startup tracking, single-instance setup, Wails, or any other code that
	// could log, persist, or consume the one-time authentication exchange.
