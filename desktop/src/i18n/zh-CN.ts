...
export const zhCN: typeof en = {
  ...
  settings: {
    ...
    telegramTitle: "Telegram 机器人集成",
    telegramConnected: "已连接",
    telegramConnecting: "连接中",
    telegramEnabled: "已启用",
    telegramFailed: "连接失败",
    telegramDisconnected: "已断开",
    telegramSummaryMissing: "尚未配置 Bot Token",
    telegramSummaryToken: "Token {token}",
    telegramSummaryDetail: "{token} · {access}",
    telegramConnect: "连接",
    telegramConfigure: "配置",
    telegramDisconnect: "断开连接",
    telegramConfigureTitle: "配置 Telegram",
    telegramConfigureHint: "输入 @BotFather 提供的 Bot Token 以接收和回复消息。",
    telegramBotToken: "Bot Token",
    telegramBotTokenHint: "粘贴你从 @BotFather 获取的 Token（例如 123456:ABC-DEF…）。",
    telegramOwnerUserId: "所有者用户 ID",
    telegramOwnerUserIdHint: "你的 Telegram 用户 ID（可选 — 限制仅此用户可访问。留空则仅允许白名单）。",
    telegramAllowlistHint: "允许与机器人对话的 Telegram 用户 ID，用逗号分隔。",
    telegramAccess: "访问控制",
    telegramAccessOwner: "所有者 {userId}",
    telegramAccessOwnerWithAllowlist: "所有者 {userId} + 白名单 {count}",
    telegramAccessAllowlist: "白名单 {count}",
    telegramAccessRuntime: "首个私聊用户（仅本次运行，{userId}）",
    telegramAccessOpen: "未绑定",
    telegramSave: "保存",
    telegramSaveAndConnect: "保存并连接",
    telegramBack: "返回",
    mcpSection: "已配置",
