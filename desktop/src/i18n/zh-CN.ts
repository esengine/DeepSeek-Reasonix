...
export const zhCN: typeof en = {
  ...
  settings: {
    ...
    webSearchEngineBingIntl: "bing-intl — 国际索引 via www.bing.com",
  ...
  contextPanel: {
    ...
    planRefined: "已修改",
    planUntitled: "未命名计划",
    planRefiningInProgress: "计划细化中…",
    noPlansMsg: "暂无计划。生成的计划将显示在此处。",
  ...
  thread: {
    ...
    cancel: "取消",
    refine: "细化",
    cancelFeedbackLabel: "告诉 Reasonix 为什么要取消这个计划",
    refineFeedbackLabel: "告诉 Reasonix 这个计划需要怎么细化",
    skipFeedback: "跳过反馈",
    sendFeedback: "发送反馈",
    back: "返回",
    planViewInPanel: "完整计划见右侧计划面板 →",
