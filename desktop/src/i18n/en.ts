export const en = {
  ...
  contextPanel: {
    ...
    planRefining: "refining…",
    planRefined: "refined",
    planUntitled: "Untitled plan",
    planRefiningInProgress: "Refining plan…",
    noPlansMsg: "No plans yet. Plans will appear here when generated.",
  ...
  thread: {
    ...
    cancel: "Cancel",
    refine: "Refine",
    cancelFeedbackLabel: "Tell Reasonix why you want to cancel this plan",
    refineFeedbackLabel: "Tell Reasonix what to refine in this plan",
