export const en = {
  ...
  settings: {
    ...
    telegramSummaryMissing: "Bot token not configured yet",
    telegramSummaryToken: "Token {token}",
    telegramSummaryDetail: "{token} · {access}",
    telegramConnect: "Connect",
    telegramConfigure: "Configure…",
    telegramDisconnect: "Disconnect",
    telegramConfigureTitle: "Configure Telegram",
    telegramConfigureHint: "Enter a Telegram Bot token from @BotFather to receive and reply to messages.",
    telegramBotToken: "Bot Token",
    telegramBotTokenHint: "Paste the token you received from @BotFather (e.g. 123456:ABC-DEF…).",
    telegramOwnerUserId: "Owner User ID",
    telegramOwnerUserIdHint: "Your Telegram user ID (optional — restricts access to this user). Leave empty for allowlist-only.",
    telegramAllowlistHint: "Comma-separated Telegram user IDs allowed to chat with the bot.",
    telegramAccess: "Access",
    telegramAccessOwner: "Owner {userId}",
    telegramAccessOwnerWithAllowlist: "Owner {userId} + allowlist {count}",
    telegramAccessAllowlist: "Allowlist {count}",
    telegramAccessRuntime: "First sender (runtime only, {userId})",
