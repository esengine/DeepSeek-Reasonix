...
export const de: typeof en = {
  ...
  settings: {
    ...
    mcpNotBridged:
      "· Aktuelle Desktop-Sitzung nicht verbunden — starte reasonix code (TUI) neu, um wirksam zu werden",
  ...
  contextPanel: {
    ...
    planTitle: "Pläne",
    planActive: "aktiv",
    planPending: "ausstehend",
    planArchived: "erledigt",
    planCancelled: "abgebrochen",
    planRefining: "wird verfeinert…",
    planRefined: "verfeinert",
    planUntitled: "Unbenannter Plan",
    planRefiningInProgress: "Plan wird verfeinert…",
    noPlansMsg: "Noch keine Pläne. Generierte Pläne erscheinen hier.",
  ...
  thread: {
    ...
    cancel: "Abbrechen",
    refine: "Verfeinern",
    planViewInPanel: "Vollständiger Plan im Plans-Panel →",
