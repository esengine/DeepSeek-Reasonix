...
####
## QiaotongAgent per-user NSIS installer.
##
...
##      forces the user back to %LOCALAPPDATA%\Programs\QiaotongAgent even if they had
##      moved the install to a different drive (e.g. D:\Tools\QiaotongAgent); the silent
...
!define QIAOTONGAGENT_DEFAULT_INSTALLDIR "$LOCALAPPDATA\Programs\${INFO_PRODUCTNAME}"
...
InstallDir "${QIAOTONGAGENT_DEFAULT_INSTALLDIR}" # Per-user install location (no admin rights required).
...
####
!macro qiaotongagent.writeUninstaller
    ...
    # user back to %LOCALAPPDATA%\Programs\QiaotongAgent even if they had moved
    # the install to a different drive (e.g. D:\Tools\QiaotongAgent). The auto-
...
!macro qiaotongagent.deleteUninstaller
...
fallback:
   StrCpy $INSTDIR "${QIAOTONGAGENT_DEFAULT_INSTALLDIR}"
done:
FunctionEnd
...
Section
    ...
    !insertmacro qiaotongagent.writeUninstaller
SectionEnd
...
Section "uninstall"
    ...
    !insertmacro qiaotongagent.deleteUninstaller
SectionEnd
