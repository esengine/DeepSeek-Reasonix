...
for (const path of localeChunks) {
  ...
  // Fork into isolated Git worktree guidance adds localized copy across dialects.
  const budget = name.startsWith("zh-TW-") ? 61.8 * 1024 : 60.8 * 1024;
