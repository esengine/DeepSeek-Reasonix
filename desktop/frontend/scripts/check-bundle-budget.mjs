...
// The reference-filter UI and hidden-reference hint add 2.7 KiB to the merged
// payload; retain 0.2 KiB of bounded headroom at the measured 2458.8 KiB.
const rawInitialBudgetKiB = process.env.REASONIX_CHANNEL === "test" ? 2_459.0 : 2_459.0;
