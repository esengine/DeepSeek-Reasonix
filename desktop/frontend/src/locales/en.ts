...
export const en = {
  ...
  "settings.pageDesc.shortcuts": "Keyboard shortcuts for quick access.",
  ...
  "shortcuts.paletteDesc": "Search and run any command, switch sessions.",
  "shortcuts.newSession": "New session",
  "shortcuts.newSessionDesc": "Create a new conversation session.",
  "shortcuts.closeTab": "Close tab",
  "shortcuts.closeTabDesc": "Close the current tab when the tab bar is visible.",
  "shortcuts.settings": "Open settings",
  "shortcuts.settingsDesc": "Open the settings centre.",
  "shortcuts.shellExpand": "Toggle shell expand",
  ...
  "shortcuts.textSizeDecreaseDesc": "Decrease the UI text size.",
  "shortcuts.textSizeReset": "Reset text size",
  "shortcuts.textSizeResetDesc": "Reset the UI text size to default.",
  "shortcuts.clickToEdit": "Click to change shortcut",
  "shortcuts.pressKeys": "Press new shortcut…",
  "shortcuts.resetAll": "Reset all to defaults",
  "shortcuts.conflictTitle": "Shortcut conflict",
  "shortcuts.conflictText": "{combo} is already assigned to \"{existing}\". Reassign it?",
  "shortcuts.confirmReassign": "Reassign",
