...
export const en = {
  ...
  "caps.status": "Status",
  "caps.auth": "Auth",
  "caps.authPossible": "May need authorization",
  "caps.authPossibleShort": "may need authorization",
  "caps.authRequired": "Needs authorization",
  "caps.authRequiredSummary": "Reauthorization or an updated token is required",
  ...
  "caps.clearAuth": "Clear authentication",
  "caps.confirmClearAuth": "Confirm clear authentication",
  "caps.clearAuthHint": "Removes local auth tokens, headers, and env values. The MCP server stays configured.",
  ...
  "settings.balanceUrlHint": "Optional. If set, the wallet balance is queried and shown in the status bar.",
	...
	"settings.supportedEfforts": "Supported Effort Levels",
	"settings.supportedEffortsPlaceholder": "auto, low, medium, high",
	"settings.supportedEffortsHint": "Comma-separated list of effort levels this provider supports. Leave empty to hide the effort switcher.",
	"settings.defaultEffort": "Default Effort",
	"settings.defaultEffortHint": "Fallback when the selected level is not supported by the provider.",
  ...
  "onboarding.tagline": "Paste a DeepSeek API key to start. Stored locally on this machine, never sent anywhere else.",
  ...
  "onboarding.privacy": "Stored only on this machine",
