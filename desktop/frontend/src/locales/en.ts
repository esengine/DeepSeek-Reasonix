...
export const en = {
  ...
  // application menu
  "appMenu.navigation": "Application menu",
  "appMenu.file": "File",
  "appMenu.edit": "Edit",
  "appMenu.view": "View",
  ...
  "sidebar.recentEmpty": "No recent chats yet.",
  "sidebar.all": "All",
  ...
  "rightDock.launcher": "Workspace launcher",
  "rightDock.newSideChat": "New side chat",
  "rightDock.showTerminal": "Show terminal",
  "rightDock.hideTerminal": "Hide terminal",
  "rightDock.terminal": "Terminal",
  "rightDock.terminalEmpty": "No command output yet",
  "rightDock.terminalExited": "Terminal session ended",
  "rightDock.terminalPlaceholder": "Type a shell command…",
  "rightDock.terminalRunning": "Running",
  "rightDock.browserPrompt": "Open website",
  "rightDock.filesTitle": "Files",
  "rightDock.filesDesc": "Browse project files",
  "rightDock.sideChatTitle": "Side chat",
  "rightDock.sideChatDesc": "Start a side conversation",
  "rightDock.browserTitle": "Browser",
  "rightDock.browserDesc": "Open website",
  "rightDock.reviewTitle": "Review",
  "rightDock.reviewDesc": "View code changes",
  "rightDock.terminalTitle": "Terminal",
  "rightDock.terminalDesc": "Start an interactive shell",
  ...
  // thread workspace
  "thread.openEditor": "Open editor",
  "thread.controls": "Thread controls",
  "environment.title": "Environment",
  "environment.settings": "Environment settings",
  "environment.changes": "Changes",
  "environment.local": "Local",
  "environment.thread": "Current thread",
  "environment.submitPush": "Commit or push",
  ...
  // welcome / empty state
  "welcome.title": "What should we do?",
  "welcome.tagline": "Your AI coding assistant for building better code faster.",
  ...
  // composer
  "composer.placeholder": "Type freely, or paste code / images / files...",
  ...
  "composer.accessYoloTitle": "YOLO approval skips all tool permission approvals",
  ...
  "composer.modeTitle": "Tool access menu; shift+tab toggles plan mode",
  ...
  "status.compactLabel": "compact",
  "status.cacheLabel": "turn hit",
  "status.cacheAvgLabel": "avg",
  "status.costLabel": "run",
  ...
  "projectTree.pinTopic": "Pin chat",
  "projectTree.unpinTopic": "Unpin chat",
  ...
  "projectTree.archiveChat": "Archive chat",
  "projectTree.archiveChats": "Archive chats",
  "projectTree.markUnread": "Mark as unread",
  "projectTree.markRead": "Mark as read",
  "projectTree.copyWorkdir": "Copy working directory",
  "projectTree.copyTopicId": "Copy session ID",
  "projectTree.copyDeepLink": "Copy deep link",
  "projectTree.deriveLocal": "Derive locally",
  "projectTree.deriveWorktree": "Derive to new worktree",
  "projectTree.openNewWindow": "Open in new window",
  "projectTree.remove": "Remove",
  "projectTree.removeChat": "Remove",
  ...
  "projectTree.revealInFinder": "Open in Finder",
  "projectTree.revealInExplorer": "Open in File Explorer",
  "projectTree.revealInFileManager": "Open in file manager",
  ...
  "settings.tabSub.archived": "Deleted sessions",
  ...
  "settings.fontFamilyHarmony": "HarmonyOS Sans",
  ...
  "settings.pageDesc.archived": "Review, restore, or permanently delete archived chats.",
