...
export const en = {
  ...
  "caps.updateManagedByNpx": "Managed by npx/npm; Reasonix does not pin this runtime",
  "caps.updateManagedByNpxShort": "Updates via npx",
  "caps.updateBundledWithApp": "Updated with the Reasonix app",
  ...
  "status.turnCostTitle": "Model spend in the current or most recent turn.",
  ...
  "status.spendTitle": "Total spend in this session",
  ...
  "settings.personality.enable": "Enable personality module",
  "settings.personality.enableHint": "When enabled, IDENTITY.md, SOUL.md, and USER.md are injected into the system prompt to shape the agent's behaviour.",
  "settings.personality.exists": "Created",
  "settings.personality.notCreated": "Not created",
  "settings.personality.placeholder": "Write your personality instructions in Markdown…",
  "settings.personality.selectFile": "Select a file from the list to edit.",
  "settings.personality.clear": "Delete file",
  "settings.personality.file": "File to edit",
  "settings.personalityMeta": "identity · soul · user",
  ...
  "settings.pageDesc.personality": "Define the agent's identity, soul, and user profile through markdown files.",
