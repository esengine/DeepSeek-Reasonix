...
export const en = {
  ...
  "sidebar.navigation": "QiaotongAgent navigation",
  ...
  "caps.upgradeBuiltInMCP": "Upgrade built-in MCP",
  "caps.updateNoticeTitle": "Built-in MCP update status",
  "caps.updatePolicy": "Update source",
  "caps.updateAvailable": "New version {latest} available (current {current})",
  "caps.updateDownloaded": "{latest} is pre-downloaded; upgrade to enable it",
  "caps.updateActivated": "Upgraded to {latest}; new connections will use it",
  "caps.updateCurrent": "Already current at {current}",
  "caps.updateError": "Update check failed",
  "caps.updateErrorWithMessage": "Update check failed: {err}",
  "caps.updateCodegraphManual": "Background checks run safely; CodeGraph can be upgraded manually",
  "caps.updateManagedByNpx": "Managed by npx/npm; QiaotongAgent does not pin this runtime",
  "caps.updateManagedByNpxShort": "Updates via npx",
  "caps.updateBundledWithApp": "Updated with the QiaotongAgent app",
  "caps.updateBundledWithAppShort": "Updates with app",
  "caps.updateNotManaged": "Independent updates are not supported",
  "caps.updateBadgeAvailable": "Update",
  "caps.updateBadgeDownloaded": "Downloaded",
  "caps.updateBadgeActivated": "Upgraded",
  "caps.updateBadgeError": "Check failed",
  "caps.updateToastAvailable": "{name} {latest} is available; upgrade it in MCP settings.",
  "caps.updateToastDownloaded": "{name} {latest} is downloaded; enable it in MCP settings.",
  "caps.updateToastActivated": "{name} upgraded to {latest}.",
  "caps.updateToastError": "{name} update check failed.",
  ...
  // composer
  "composer.placeholder": "Message QiaotongAgent…  ( / commands · @ files · ! shell )",
  ...
  "memory.noDocs": "No QIAOTONGAGENT.md found. Quick-add one above.",
  ...
  "memory.emptySavedBody": "Save durable background only when it should help future QiaotongAgent sessions in this project.",
  ...
  "settings.closeBehavior.quit": "Quit QiaotongAgent",
  ...
  "settings.agentRuntimeHint": "Used as global defaults; ./qiaotongagent.toml can override them per project. 0 means unlimited.",
  ...
  "settings.botInstallSubtitle": "Once connected, QiaotongAgent can be used from chat.",
  ...
  "settings.botInstallManualQQ": "Enter the App ID and App secret. The secret is stored only in local credentials.",
  ...
  "settings.pageDesc.memory": "Manage preferences, project conventions, and instruction files QiaotongAgent keeps referencing.",
  ...
  "settings.addProvider.officialChoiceHint": "Choose from QiaotongAgent presets for DeepSeek and Mimo.",
  ...
  "settings.addProvider.official.mimoApiDesc": "For pay-as-you-go API users, with mimo-v2.5-pro plus image-capable mimo-v2.5 / mimo-v2-omni.",
  "settings.addProvider.official.mimoTokenPlan": "Mimo Token Plan",
  "settings.addProvider.official.mimoTokenPlanDesc": "For Token Plan subscribers using the dedicated endpoint, with pro and image-capable mimo-v2.5.",
  ...
  "settings.hooksPathProjectHint": "Project hooks are saved to .qiaotongagent/settings.json in the current workspace.",
  ...
  "settings.hooksGlobalHint": "Saved globally. Restart QiaotongAgent to load new hooks.",
  "settings.hooksProjectHint": "Saved in this workspace. Project hooks load after trust and a QiaotongAgent restart.",
  ...
  "updater.autoCheckHint": "When off, QiaotongAgent won't check automatically when it opens. You can still check manually here.",
  ...
  "onboarding.title": "Connect QiaotongAgent",
  ...
  // crash page
  "crash.title": "QiaotongAgent hit an error — send us the report, or copy it",
  "crash.copy": "Copy",
  ...
  "performanceReport.title": "QiaotongAgent noticed a responsiveness issue",
  ...
  "mock.askQ2Header": "QiaotongAgent build",
  "mock.askQ2Prompt": "What do you want to do about the missing qiaotongagent binary?",
