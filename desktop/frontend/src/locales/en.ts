...
export const en = {
  ...
  "workspace.stagedChanges": "Staged",
  "workspace.unstagedChanges": "Unstaged",
  "workspace.stageAll": "Stage all",
  "workspace.unstageAll": "Unstage all",
  "workspace.stageFile": "Stage",
  "workspace.unstageFile": "Unstage",
  "workspace.commit": "Commit",
  "workspace.commitAndPush": "Commit & Push",
  "workspace.commitDialogTitle": "Commit staged changes",
  "workspace.commitBranch": "Target branch",
  "workspace.commitMessagePlaceholder": "Commit message",
  "workspace.branchSearchPlaceholder": "Search or create branch",
  "workspace.createBranch": "Create \"{branch}\"",
  "workspace.noBranch": "Current branch",
  "workspace.noBranches": "No branches found",
  "workspace.pickChangedFile": "Choose a changed file from the tree.",
  "workspace.gitStaged": "File staged.",
  "workspace.gitUnstaged": "File unstaged.",
  "workspace.gitStagedAll": "All unstaged changes staged.",
  "workspace.gitUnstagedAll": "All staged changes unstaged.",
  "workspace.gitCommitted": "Changes committed.",
  "workspace.gitCommittedPushed": "Changes committed and pushed.",
