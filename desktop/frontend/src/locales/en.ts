...
export const en = {
  ...
  "settings.providerLabel.zhipu": "Zhipu GLM",
  ...
  "settings.addProvider.official.zhipu": "Zhipu GLM (智谱)",
  "settings.addProvider.official.zhipuDesc": "OpenAI-compatible GLM-4.7 / GLM-5.2 with built-in reasoning. Coding Plan subscribers: set ZHIPU_API_KEY.",
