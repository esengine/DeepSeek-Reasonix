...
export const en = {
  ...
  "settings.autostartLabel": "Launch at login",
  "settings.autostartHint": "When on, Reasonix will start automatically when you log in to your computer.",
  "settings.minimizeToTrayLabel": "Minimize to tray on startup",
  "settings.minimizeToTrayHint": "When on, Reasonix will start minimized to the system tray instead of showing the main window.",
