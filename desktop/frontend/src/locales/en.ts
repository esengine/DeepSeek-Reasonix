...
export const en = {
  ...
  "memory.summarySettings": "{facts} saved · {archives} archived · {docs} instruction files · current project",
  ...
  "memory.emptySavedTitle": "No project memories yet",
