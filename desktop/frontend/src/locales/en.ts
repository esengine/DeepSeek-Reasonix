...
export const en = {
  ...
  "settings.balanceUrlHint": "Optional. If set, the wallet balance is queried and shown in the status bar.",
	...
	"settings.sessionEffort": "Session Effort",
	"settings.sessionEffortHint": "Active effort level for the current session. \"auto\" omits the field from API requests (cache-safe).",
	"settings.sessionProvider": "Session Provider",
	"settings.sessionProviderHint": "Active provider for the current session. Switching adapts effort to the new provider's capability.",
