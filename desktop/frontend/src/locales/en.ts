...
export const en = {
  ...
  "daemonApprovals.active": "active wait",
  ...
  "daemonApprovals.queue": "Approval queue",
  "daemonApprovals.target": "Session",
  "daemonApprovals.goal": "Goal",
  "daemonApprovals.source": "Source",
  "daemonApprovals.tool": "Tool",
  "daemonApprovals.runStatus": "Run",
  "daemonApprovals.waitState": "Wait",
  "daemonApprovals.since": "Since",
  "daemonApprovals.actionSummary": "Action summary",
  "daemonApprovals.noSummary": "No summary",
  "daemonApprovals.answerPlaceholder": "Type an answer for this question...",
  "daemonApprovals.actionFailed": "Daemon action failed: {err}",
  "daemonProcess.title": "Daemon process",
  "daemonProcess.connected": "online",
  "daemonProcess.offline": "offline",
  "daemonProcess.running": "running",
  "daemonProcess.sessionCount": "{count} sessions",
  "daemonProcess.start": "Start",
  "daemonProcess.stop": "Stop",
  "daemonProcess.restart": "Restart",
  "daemonProcess.show": "Show",
  "daemonProcess.hide": "Hide",
  "daemonProcess.pid": "PID",
  "daemonProcess.uptime": "Uptime",
  "daemonProcess.addr": "Address",
  "daemonProcess.sessions": "Sessions",
  "daemonProcess.startup": "Startup",
  "daemonProcess.startupDescription": "Install a user-level login helper so the local daemon starts with your system session.",
  "daemonProcess.lastError": "Last error",
  "daemonSessions.title": "Daemon sessions",
  "daemonSessions.connected": "online",
  "daemonSessions.offline": "offline",
  "daemonSessions.visibleCount": "{visible}/{total}",
  "daemonSessions.sessionCount": "{count} sessions",
  "daemonSessions.uptime": "up {uptime}",
  "daemonSessions.show": "Show",
  "daemonSessions.hide": "Hide",
  "daemonSessions.empty": "No daemon sessions match the current filter.",
  "daemonSessions.openBadge": "open",
  "daemonSessions.open": "Open",
  "daemonSessions.continue": "Continue",
  "daemonSessions.stop": "Stop",
  "daemonSessions.disableSchedule": "No schedule",
  "daemonSessions.disableWatch": "No watch",
  "daemonSessions.scheduled": "scheduled",
  "daemonSessions.watched": "watch",
  "daemonSessions.nextWakeup": "next {time}",
  "daemonSessions.budgetWakeups": "wakeups {used}/{limit}",
  "daemonSessions.budgetModels": "models {used}/{limit}",
  "daemonSessions.budgetCost": "cost {used}/{limit}",
  "daemonSessions.budgetBlocked": "budget blocked",
  "daemonSessions.filter.all": "All",
  "daemonSessions.filter.project": "Project",
  "daemonSessions.filter.global": "Global",
  "daemonSessions.filter.running": "Running",
  "daemonSessions.filter.waiting": "Waiting",
  "daemonSessions.filter.blocked": "Blocked",
