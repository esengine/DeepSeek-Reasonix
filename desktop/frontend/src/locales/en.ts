...
export const en = {
  ...
  "settings.fontFamilyCustomPlaceholder": "Font stack, e.g. \"LXGW WenKai\", \"JetBrains Mono\", monospace",
  ...
  "settings.pageDesc.bots": "Configure Feishu, Lark, and WeChat bot channels, including each bot's model and runtime parameters.",
  ...
  "settings.hooksGlobalHint": "Saved globally. New Reasonix sessions load it after /new or restart.",
  "settings.hooksProjectHint": "Saved in this workspace. Project hooks load only after trust and a /new or restart.",
