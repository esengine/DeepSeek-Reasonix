...
export const en = {
  ...
  "settings.turnTreeLayout": "Conversation tree layout",
  "settings.turnTreeLayoutTree": "Tree",
  "settings.turnTreeLayoutLanes": "Lanes",
  "settings.turnTreeLayoutMetro": "Metro",
  ...
  "turnTree.title": "Conversation tree",
  "turnTree.summary": "Focused tree for this conversation",
  "turnTree.selected": "Selected T{turn} · {branch}",
  "turnTree.zoomOut": "Zoom out",
  "turnTree.zoomIn": "Zoom in",
  "turnTree.currentNode": "Current node",
  "turnTree.refresh": "Refresh",
  "turnTree.retry": "Retry",
  "turnTree.loading": "Loading tree…",
  "turnTree.empty": "No conversation turns yet",
  "turnTree.emptyPrompt": "(empty)",
  "turnTree.current": "current",
  "turnTree.toggleForks": "Toggle {count} forks",
  "turnTree.actionTitle": "Open T{turn}",
  "turnTree.openCurrent": "Open in current session",
  "turnTree.openNew": "Open in new session",
  "turnTree.openNewFailed": "Could not open a new session",
  "turnTree.newTopicTitle": "Opened from T{turn}",
  "turnTree.prefixChars": "{count} chars",
  "turnTree.prefixLabel": "Prefix",
  "turnTree.responseLabel": "AI",
