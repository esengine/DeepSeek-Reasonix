...
export const en = {
  ...
  "settings.fileEncoding": "File encoding",
  "settings.fileEncoding.auto": "Auto-detect",
  "settings.fileEncoding.hint": "Encoding used when reading/writing project files. Auto-detect works for most UTF-8 projects.",
