...
export const en = {
  ...
  "memory.allTypes": "All",
  "memory.typeLabel.user": "User",
  "memory.typeLabel.feedback": "Feedback",
  "memory.typeLabel.project": "Project",
  "memory.typeLabel.reference": "Reference",
  ...
  "settings.notificationSoundAttention": "AI asks a question",
  "settings.notificationSound.synth": "Synthesized (default)",
  ...
  "settings.defaultYolo": "Default YOLO mode",
  "settings.defaultYoloHint": "New conversations start in YOLO mode, auto-running every tool call without asking.",
