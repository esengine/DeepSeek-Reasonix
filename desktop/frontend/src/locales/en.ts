...
export const en = {
  ...
  "memory.addInstructionFile": "Add instruction file",
  "memory.addInstructionFileHint": "Create a REASONIX/AGENTS Markdown file for durable rules and project conventions.",
  "memory.instructionPlaceholder": "Write the durable instruction to keep in context…",
  "memory.saveInstructionFile": "Save instruction file",
  "memory.expandDoc": "Expand preview",
  "memory.noDocs": "No instruction file found.",
