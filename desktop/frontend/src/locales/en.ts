...
export const en = {
  ...
  "caps.rememberChoice": "Remember choice",
  "caps.advancedSettings": "Advanced settings",
  "caps.exitAdvanced": "Exit advanced",
  "caps.advancedSettingsHint": "Per-server control: choose on, off this session, or off always for each MCP server",
  "caps.mcpOn": "On",
  "caps.mcpOffSession": "Off this session",
  "caps.mcpOffAlways": "Off (always)",
