...
export const zh: Record<DictKey, string> = {
  ...
  "settings.turnTreeLayout": "会话树布局",
  "settings.turnTreeLayoutTree": "树图",
  "settings.turnTreeLayoutLanes": "泳道",
  "settings.turnTreeLayoutMetro": "线路图",
  ...
  "turnTree.title": "会话树",
  "turnTree.summary": "查看当前会话所在分支树",
  "turnTree.selected": "已选择 T{turn} · {branch}",
  "turnTree.zoomOut": "缩小",
  "turnTree.zoomIn": "放大",
  "turnTree.currentNode": "当前节点",
  "turnTree.refresh": "刷新",
  "turnTree.retry": "重试",
  "turnTree.loading": "正在加载会话树…",
  "turnTree.empty": "还没有会话轮次",
  "turnTree.emptyPrompt": "（空）",
  "turnTree.current": "当前",
  "turnTree.toggleForks": "切换 {count} 个分支",
  "turnTree.actionTitle": "打开 T{turn}",
  "turnTree.openCurrent": "当前会话打开",
  "turnTree.openNew": "新会话打开",
  "turnTree.openNewFailed": "无法打开新会话",
  "turnTree.newTopicTitle": "从 T{turn} 打开",
  "turnTree.prefixChars": "{count} 字符",
  "turnTree.prefixLabel": "前缀",
  "turnTree.responseLabel": "AI 回复",
