...
export const zh: Record<DictKey, string> = {
  ...
  "settings.balanceUrlHint": "可选。填了就会查询并在状态栏显示钱包余额。",
	...
	"settings.supportedEfforts": "支持的推理深度级别",
	"settings.supportedEffortsPlaceholder": "auto, low, medium, high",
	"settings.supportedEffortsHint": "逗号分隔的推理深度级别列表。留空则隐藏推理深度切换器。",
	"settings.defaultEffort": "默认推理深度",
	"settings.defaultEffortHint": "当选择的级别不被模型支持时的回退值。",
	"settings.sessionEffort": "会话推理深度",
	"settings.sessionEffortHint": "当前会话的推理深度级别。\"auto\" 不发送参数（保护 Prefix Cache）。",
	"settings.sessionProvider": "会话模型服务",
	"settings.sessionProviderHint": "当前会话的模型服务。切换时自动适配新模型服务的能力。",
