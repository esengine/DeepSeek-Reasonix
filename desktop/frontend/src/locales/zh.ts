...
export const zh: Record<DictKey, string> = {
  ...
  "caps.updateManagedByNpx": "由 npx/npm 管理，Reasonix 不托管固定版本",
  "caps.updateManagedByNpxShort": "由 npx 管理更新",
  "caps.updateBundledWithApp": "随 Reasonix 应用本体更新",
  ...
  "settings.personality.enable": "启用人格模块",
  "settings.personality.enableHint": "启用后，IDENTITY.md、SOUL.md 和 USER.md 将被注入系统提示词，用来塑造 Agent 的行为。",
  "settings.personality.exists": "已创建",
  "settings.personality.notCreated": "未创建",
  "settings.personality.placeholder": "用 Markdown 编写人格指令…",
  "settings.personality.selectFile": "从列表中选择一个文件进行编辑。",
  "settings.personality.clear": "删除文件",
  "settings.personality.file": "选择文件",
  "settings.personalityMeta": "身份 · 灵魂 · 用户",
  ...
  "settings.pageDesc.personality": "通过 Markdown 文件定义 Agent 的身份、灵魂和用户画像。",
