...
export const zh: Record<DictKey, string> = {
  ...
  "sidebar.navigation": "QiaotongAgent 导航",
  "sidebar.plugins": "插件",
  ...
  "caps.reconnect": "重新连接",
  "caps.upgradeBuiltInMCP": "升级内置 MCP",
  "caps.updateNoticeTitle": "内置 MCP 更新状态",
  "caps.updatePolicy": "更新方式",
  "caps.updateAvailable": "有新版本 {latest}（当前 {current}）",
  "caps.updateDownloaded": "已预下载 {latest}，可点击升级启用",
  "caps.updateActivated": "已升级到 {latest}，新连接会使用新版",
  "caps.updateCurrent": "已是最新版本 {current}",
  "caps.updateError": "检查更新失败",
  "caps.updateErrorWithMessage": "检查更新失败：{err}",
  "caps.updateCodegraphManual": "后台会检查更新；可手动升级 CodeGraph runtime",
  "caps.updateManagedByNpx": "由 npx/npm 管理，QiaotongAgent 不托管固定版本",
  "caps.updateManagedByNpxShort": "由 npx 管理更新",
  "caps.updateBundledWithApp": "随 QiaotongAgent 应用本体更新",
  "caps.updateBundledWithAppShort": "随应用更新",
  "caps.updateNotManaged": "当前不支持独立升级",
  "caps.updateBadgeAvailable": "有更新",
  "caps.updateBadgeDownloaded": "已预下载",
  "caps.updateBadgeActivated": "已升级",
  "caps.updateBadgeError": "检查失败",
  "caps.updateToastAvailable": "{name} 有新版本 {latest}，可在 MCP 管理页升级。",
  "caps.updateToastDownloaded": "{name} {latest} 已预下载，可在 MCP 管理页启用。",
  "caps.updateToastActivated": "{name} 已升级到 {latest}。",
  "caps.updateToastError": "{name} 更新检查失败。",
  "caps.command": "命令",
  "caps.url": "URL",
  "caps.envKeys": "环境变量",
  ...
  // 输入框
  "composer.placeholder": "给 QiaotongAgent 发消息…  ( / 命令 · @ 文件 · ! 终端 )",
  ...
  "memory.noDocs": "未找到 QIAOTONGAGENT.md。可在上方快速添加一条。",
  ...
  "memory.emptySavedBody": "只保存对后续 QiaotongAgent 会话有帮助的长期背景。",
  ...
  "settings.agentRuntimeHint": "作为全局默认；项目里的 ./qiaotongagent.toml 可覆盖。0 表示不限。",
  ...
  "settings.botInstallSubtitle": "连接完成后即可在聊天里调用 QiaotongAgent。",
  ...
  "settings.botInstallManualQQ": "填写 App ID 和 App Secret；密钥只保存到本机 credentials。",
  ...
  "settings.pageDesc.memory": "管理 QiaotongAgent 会长期参考的偏好、项目约定和指令文件。",
  ...
  "settings.addProvider.officialChoiceHint": "从 QiaotongAgent 预设的 DeepSeek 与 Mimo 接入中选择。",
  ...
  "settings.addProvider.official.mimoApiDesc": "适合按量 API 计费用户，包含 mimo-v2.5-pro 以及可识图的 mimo-v2.5 / mimo-v2-omni。",
  "settings.addProvider.official.mimoTokenPlan": "Mimo Token Plan",
  "settings.addProvider.official.mimoTokenPlanDesc": "适合 Token Plan 订阅用户，使用专属接入地址，包含 pro 与可识图的 mimo-v2.5。",
  ...
  "settings.hooksPathProjectHint": "项目 hooks 保存到当前工作区的 .qiaotongagent/settings.json。",
  ...
  "settings.hooksGlobalHint": "保存为全局配置。重启 QiaotongAgent 后加载新的 hooks。",
  "settings.hooksProjectHint": "保存在当前工作区。项目 hooks 需要信任，并在重启 QiaotongAgent 后加载。",
  ...
  "updater.autoCheckHint": "关闭后，QiaotongAgent 打开时不会自动检查更新；你仍可在此页手动检查。",
  ...
  "onboarding.title": "连接 QiaotongAgent",
  ...
  // 崩溃兜底页
  "crash.title": "QiaotongAgent 遇到错误 —— 可以一键发送报告，或复制后反馈",
  "crash.copy": "复制",
  "crash.send": "发送报告",
  "crash.sending": "发送中…",
  "crash.sent": "已发送，谢谢！",
  ...
  "performanceReport.title": "QiaotongAgent 检测到响应卡顿",
  ...
  "mock.askQ2Header": "QiaotongAgent 构建",
  "mock.askQ2Prompt": "对于 qiaotongagent 二进制缺失的问题，你想怎么做？",
