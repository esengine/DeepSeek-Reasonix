...
export const zh: Record<DictKey, string> = {
  ...
  "workspace.stagedChanges": "已暂存",
  "workspace.unstagedChanges": "未暂存",
  "workspace.stageAll": "暂存全部",
  "workspace.unstageAll": "取消所有暂存",
  "workspace.stageFile": "暂存",
  "workspace.unstageFile": "取消暂存",
  "workspace.commit": "提交",
  "workspace.commitAndPush": "提交并推送",
  "workspace.commitDialogTitle": "提交已暂存改动",
  "workspace.commitBranch": "目标分支",
  "workspace.commitMessagePlaceholder": "提交信息",
  "workspace.branchSearchPlaceholder": "搜索或新建分支",
  "workspace.createBranch": "新建 {branch}",
  "workspace.noBranch": "当前分支",
  "workspace.noBranches": "未找到分支",
  "workspace.pickChangedFile": "从改动文件树中选择一个文件。",
  "workspace.gitStaged": "文件已暂存。",
  "workspace.gitUnstaged": "文件已取消暂存。",
  "workspace.gitStagedAll": "已暂存全部未暂存改动。",
  "workspace.gitUnstagedAll": "已取消所有暂存。",
  "workspace.gitCommitted": "改动已提交。",
  "workspace.gitCommittedPushed": "改动已提交并推送。",
