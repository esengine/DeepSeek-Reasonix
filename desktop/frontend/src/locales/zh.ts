...
export const zh: Record<DictKey, string> = {
  ...
  "settings.providerLabel.zhipu": "智谱 GLM",
  ...
  "settings.addProvider.official.zhipu": "智谱 GLM",
  "settings.addProvider.official.zhipuDesc": "OpenAI 兼容的 GLM-4.7 / GLM-5.2，自带思考链。Coding Plan 用户设置 ZHIPU_API_KEY 即可。",
