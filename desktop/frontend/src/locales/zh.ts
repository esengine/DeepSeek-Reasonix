...
export const zh: Record<DictKey, string> = {
  ...
  "rightDock.browserOpen": "前往",
  "rightDock.browserGo": "导航到",
  "rightDock.browserOpenExternal": "在系统浏览器中打开",
  "rightDock.browserEmpty": "输入网址浏览网页",
  "rightDock.closeTab": "关闭标签",
  "rightDock.addTab": "新建标签",

  "memory.globalMemories": "全局记忆",

  "projectTree.emptyNoTimeFilterMatch": "此时间范围内没有话题",
