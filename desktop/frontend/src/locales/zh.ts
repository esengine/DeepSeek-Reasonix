...
export const zh: Record<DictKey, string> = {
  ...
  "composer.quickParallel": "并发",
  "composer.quickParallelDesc": "并行执行独立任务",
  "composer.quickSummary": "总结",
  "composer.quickSummaryDesc": "总结此会话",
  ...
  "settings.botInstallManualQQ": "填写 App ID 和 App Secret；密钥只保存到本机凭据存储。",
  ...
  "settings.metricsHint": "默认开启。发送匿名的轮次结束统计和设置偏好快照（如桌面风格、主题、Provider/模型标识、客户端版本与机器人开关），以及用于 DAU 去重的随机安装 ID。Bucket 可能包含归一化后的自定义 Provider 名和模型名——绝不包含对话、提示词、密钥、路径、base URL 或文件内容。",
  ...
  "onboarding.tagline": "粘贴一个 DeepSeek API key 即可开始。密钥仅存于本机凭据存储，不会发往任何地方。",
