...
export const zh: Record<DictKey, string> = {
  ...
  "settings.notificationSoundHint": "为不同事件选择音效",
  "settings.notificationSoundSuccess": "生成完成",
  "settings.notificationSoundAttention": "AI 提问时",
  "settings.notificationSound.synth": "合成音（默认）",
  "settings.notificationSound.positive": "积极通知",
  "settings.notificationSound.correct": "正确提示音",
  "settings.notificationSound.start": "启动音",
  "settings.notificationSound.back": "返回音",
  "settings.notificationSoundPreview": "预览",
  "settings.generativeMusic": "生成式背景音乐",
  "settings.generativeMusicHint": "AI 生成时循环播放的环境音乐",
  ...
  "settings.generativeMusic.presets.digital": "数码（方波）",
  "settings.generativeMusic.presets.retro": "复古（锯齿波）",
  "settings.generativeMusicPreview": "预览",
