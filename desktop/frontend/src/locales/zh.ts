...
export const zh: Record<DictKey, string> = {
  ...
  "settings.statusBarVisible": "底部信息栏",
  "settings.statusBarVisibleHint": "控制底部信息栏的显示与隐藏。关闭后信息栏会向下滑出消失。",
  "settings.statusBarVisible.on": "显示",
  "settings.statusBarVisible.off": "隐藏",
