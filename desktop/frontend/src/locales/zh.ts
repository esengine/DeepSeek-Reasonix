...
export const zh: Record<DictKey, string> = {
  ...
  "status.turnCostTitle": "当前或最近一轮交流累计费用。",
  ...
  "daemonApprovals.active": "活跃等待",
  "daemonApprovals.dormant": "需恢复",
  "daemonApprovals.next": "下一项",
  "daemonApprovals.submitAnswer": "提交回答",
  "daemonApprovals.session": "会话 {id}",
  "daemonApprovals.queue": "审批队列",
  "daemonApprovals.target": "会话",
  "daemonApprovals.goal": "目标",
  "daemonApprovals.source": "来源",
  "daemonApprovals.tool": "工具",
  "daemonApprovals.runStatus": "运行",
  "daemonApprovals.waitState": "等待",
  "daemonApprovals.since": "开始",
  "daemonApprovals.actionSummary": "动作摘要",
  "daemonApprovals.noSummary": "无摘要",
  "daemonApprovals.answerPlaceholder": "输入这次提问的回答…",
  "daemonApprovals.actionFailed": "Daemon 操作失败：{err}",
  "daemonProcess.title": "Daemon 进程",
  "daemonProcess.connected": "在线",
  "daemonProcess.offline": "离线",
  "daemonProcess.running": "running",
  "daemonProcess.sessionCount": "{count} 个会话",
  "daemonProcess.start": "启动",
  "daemonProcess.stop": "停止",
  "daemonProcess.restart": "重启",
  "daemonProcess.show": "展开",
  "daemonProcess.hide": "收起",
  "daemonProcess.pid": "PID",
  "daemonProcess.uptime": "Uptime",
  "daemonProcess.addr": "地址",
  "daemonProcess.sessions": "会话",
  "daemonProcess.startup": "自启动",
  "daemonProcess.startupDescription": "安装用户级登录自启动 helper，让本地 daemon 随系统会话启动。",
  "daemonProcess.lastError": "最近错误",
  "daemonSessions.title": "Daemon 常驻任务",
  "daemonSessions.connected": "在线",
  "daemonSessions.offline": "离线",
  "daemonSessions.visibleCount": "{visible}/{total}",
  "daemonSessions.sessionCount": "{count} 个会话",
  "daemonSessions.uptime": "已运行 {uptime}",
  "daemonSessions.show": "展开",
  "daemonSessions.hide": "收起",
  "daemonSessions.empty": "当前筛选下没有 daemon 会话。",
  "daemonSessions.openBadge": "已打开",
  "daemonSessions.open": "打开",
  "daemonSessions.continue": "继续",
  "daemonSessions.stop": "停止",
  "daemonSessions.disableSchedule": "关调度",
  "daemonSessions.disableWatch": "关监听",
  "daemonSessions.scheduled": "已调度",
  "daemonSessions.watched": "监听中",
  "daemonSessions.nextWakeup": "下次 {time}",
  "daemonSessions.budgetWakeups": "唤醒 {used}/{limit}",
  "daemonSessions.budgetModels": "模型 {used}/{limit}",
  "daemonSessions.budgetCost": "费用 {used}/{limit}",
  "daemonSessions.budgetBlocked": "预算阻断",
  "daemonSessions.filter.all": "全部",
  "daemonSessions.filter.project": "项目",
  "daemonSessions.filter.global": "全局",
  "daemonSessions.filter.running": "运行",
  "daemonSessions.filter.waiting": "等待",
  "daemonSessions.filter.blocked": "阻断",
