...
export const zh: Record<DictKey, string> = {
  ...
  "caps.enable": "本次会话启用",
  "caps.disable": "本次会话停用",
  "caps.rememberChoice": "记住当前选项",
  "caps.advancedSettings": "高级设置",
  "caps.exitAdvanced": "退出高级模式",
  "caps.advancedSettingsHint": "逐服务器分别设置：开启、本次会话关闭、或总是关闭",
  "caps.mcpOn": "开启",
  "caps.mcpOffSession": "本次会话关闭",
  "caps.mcpOffAlways": "总是关闭",
