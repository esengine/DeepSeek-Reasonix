...
export const zh: Record<DictKey, string> = {
  ...
  "projectTree.timeFilter10": "最新10条",
  ...
  "memory.allTypes": "全部",
  "memory.typeLabel.user": "用户",
  "memory.typeLabel.feedback": "反馈",
  "memory.typeLabel.project": "项目",
  "memory.typeLabel.reference": "参考",
  "memory.globalMemories": "全局记忆",
  ...
  "settings.notificationSoundAttention": "AI 提问",
  "settings.notificationSound.synth": "合成音效（默认）",
  ...
  "settings.generativeMusic": "生成中背景音乐",
  "settings.generativeMusicHint": "AI 生成过程中循环播放的环境音效",
  "settings.generativeMusicPreset": "音色预设",
  "settings.generativeMusic.presets.classic": "经典 (三角波)",
  "settings.generativeMusic.presets.ethereal": "空灵 (正弦波) ★",
  "settings.generativeMusic.off": "关闭",
  "settings.generativeMusic.presets.digital": "数字 (方波)",
  "settings.generativeMusic.presets.retro": "复古 (锯齿波)",
  ...
  "settings.defaultYolo": "默认 YOLO 模式",
  "settings.defaultYoloHint": "新对话自动启用 YOLO 模式，跳过所有工具调用审批。",
