...
export const zh: Record<DictKey, string> = {
  ...
  "memory.addInstructionFile": "添加指令文件",
  "memory.addInstructionFileHint": "创建 REASONIX/AGENTS Markdown 文件，用来保存长期规则和项目约定。",
  "memory.instructionPlaceholder": "写下需要长期参与上下文的指令…",
  "memory.saveInstructionFile": "保存指令文件",
  "memory.expandDoc": "展开预览",
  "memory.noDocs": "未找到指令文件。",
