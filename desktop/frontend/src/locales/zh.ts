...
export const zh: Record<DictKey, string> = {
  ...
  "settings.pageDesc.shortcuts": "键盘快捷键，快速操作。",
  ...
  "shortcuts.paletteDesc": "搜索并执行任意命令，快速切换会话。",
  "shortcuts.newSession": "新建会话",
  "shortcuts.newSessionDesc": "创建一个新的对话会话。",
  "shortcuts.closeTab": "关闭标签页",
  "shortcuts.closeTabDesc": "当顶部 Tab 栏可见时，关闭当前标签页。",
  "shortcuts.settings": "打开设置",
  "shortcuts.settingsDesc": "打开设置中心。",
  "shortcuts.shellExpand": "切换 Shell 展开",
  ...
  "shortcuts.textSizeDecreaseDesc": "减小界面文字的大小。",
  "shortcuts.textSizeReset": "重置文字大小",
  "shortcuts.textSizeResetDesc": "将界面文字大小重置为默认值。",
  "shortcuts.clickToEdit": "点击修改快捷键",
  "shortcuts.pressKeys": "按下新的快捷键…",
  "shortcuts.resetAll": "全部重置为默认值",
  "shortcuts.conflictTitle": "快捷键冲突",
  "shortcuts.conflictText": "{combo} 已被分配给「{existing}」。要重新分配吗？",
  "shortcuts.confirmReassign": "重新分配",
  "shortcuts.cancel": "取消",
