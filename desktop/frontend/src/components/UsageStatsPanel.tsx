...
const USAGE_STATS_TRANSLATIONS = {
  ...
  ru: {
    ...
    "common.none": "нет",
    "settings.stats.range": "Диапазон времени",
    ...
    "settings.stats.rangeCustom": "Свой",
    "settings.stats.from": "С",
    "settings.stats.to": "По",
    "settings.stats.source": "Источник",
    "settings.stats.source.all": "Все",
    "settings.stats.source.desktop": "Десктоп",
    "settings.stats.source.cli": "CLI",
    "settings.stats.source.serve": "Веб",
    "settings.stats.source.bot": "Бот",
    "settings.stats.source.remote": "Удаленно",
    "settings.stats.refresh": "Обновить",
    "settings.stats.tokens": "Токены",
    "settings.stats.sessions": "Завершенные ходы",
    "settings.stats.requests": "Запросы",
    "settings.stats.activeDays": "Активных дней",
    "settings.stats.cacheRate": "Средний кэш-хит",
    "settings.stats.cacheRateHint": "Доля кэшированных токенов",
    "settings.stats.cacheHitRate": "Кэш-хит",
    "settings.stats.hitRateLegend": "Кэш-хит",
    "settings.stats.topModel": "Чаще всего используемая модель",
    "settings.stats.topModelHint": "По токенам, не по кол-ву вызовов",
    "settings.stats.heatmap": "Карта активности",
    "settings.stats.heatLess": "Меньше",
    "settings.stats.heatMore": "Больше",
    "settings.stats.dailyTrend": "Тренд по дням",
    "settings.stats.trendLimited": "Показаны последние 180 дней",
    "settings.stats.modelUsage": "Использование моделей",
    "settings.stats.other": "Другое",
    "settings.stats.moreModels": "других моделей",
    "settings.stats.total": "Всего",
    "settings.stats.percent": "Доля",
    "settings.stats.asOf": "На",
    "settings.stats.empty": "Пока нет данных. Статистика пишется с момента появления функции.",
  },
} as const;
