...
const USAGE_STATS_TRANSLATIONS = {
  ...
  ru: {
    ...
    "common.none": "нет",
    "settings.stats.range": "Диапазон",
    "settings.stats.rangePreset.7": "Последние 7 дней",
    "settings.stats.rangePreset.14": "Последние 14 дней",
    "settings.stats.rangePreset.30": "Последние 30 дней",
    "settings.stats.rangePreset.90": "Последние 90 дней",
    "settings.stats.rangeCustom": "Свои",
    "settings.stats.from": "С",
    "settings.stats.to": "По",
    "settings.stats.source": "Источник",
    "settings.stats.source.all": "Все",
    "settings.stats.source.desktop": "Настольное",
    "settings.stats.source.cli": "CLI",
    "settings.stats.source.serve": "Веб",
    "settings.stats.source.bot": "Бот",
    "settings.stats.source.remote": "Удалённая",
    "settings.stats.refresh": "Обновить",
    "settings.stats.tokens": "Расход токенов",
    "settings.stats.sessions": "Завершённые ходы",
    "settings.stats.requests": "Запросы",
    "settings.stats.activeDays": "Активные дни",
    "settings.stats.cacheRate": "Средний кэш-хит",
    "settings.stats.cacheRateHint": "Доля кэшированных входных токенов среди всех входных токенов в диапазоне",
    "settings.stats.cacheHitRate": "Кэш-хит",
    "settings.stats.hitRateLegend": "Кэш-хит",
    "settings.stats.topModel": "Самая используемая модель",
    "settings.stats.topModelHint": "По объёму токенов, не по числу вызовов",
    "settings.stats.heatmap": "Тепловая карта активности",
    "settings.stats.heatLess": "Меньше",
    "settings.stats.heatMore": "Больше",
    "settings.stats.dailyTrend": "Дневной тренд токенов",
    "settings.stats.trendLimited": "Показаны последние 180 дней",
    "settings.stats.modelUsage": "Использование моделей",
    "settings.stats.other": "Прочее",
    "settings.stats.moreModels": "ещё моделей",
    "settings.stats.total": "Всего",
    "settings.stats.percent": "Доля",
    "settings.stats.asOf": "На",
    "settings.stats.empty": "За этот диапазон данных об использовании нет. Расход токенов записывается со дня появления этой функции.",
  },
} as const;
