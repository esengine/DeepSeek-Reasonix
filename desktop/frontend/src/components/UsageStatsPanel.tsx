...
const USAGE_STATS_TRANSLATIONS = {
  ...
  ru: {
    ...
    "settings.stats.cacheRate": "Средний процент попаданий в кэш",
    "settings.stats.cacheRateHint": "Кэшированные входные токены как доля всех входных токенов в диапазоне",
    "settings.stats.cacheHitRate": "Процент попаданий в кэш",
    "settings.stats.hitRateLegend": "Процент попаданий в кэш",
    "settings.stats.topModel": "Самая используемая модель",
    "settings.stats.topModelHint": "По объёму токенов, а не по числу вызовов",
    "settings.stats.heatmap": "Тепловая карта активности",
    "settings.stats.heatLess": "Меньше",
    "settings.stats.heatMore": "Больше",
    "settings.stats.dailyTrend": "Дневной расход токенов",
    ...
    "settings.stats.asOf": "По состоянию на",
    "settings.stats.empty": "За этот диапазон данных об использовании пока нет. Расход токенов фиксируется с момента выхода этой функции.",
  },
} as const;
