...
const mockAiOnlyModels = ["deepseek-v4-pro", "deepseek-v4-flash", "claude-opus-4-8", "claude-sonnet-5", "gpt-5.5", "gpt-5.4", "gemini-3.1-pro-preview", "gemini-2.5-pro", "qwen3.7-plus", "glm-5.2"];
...
const mockProviderPresetTemplates: MockProviderPresetTemplate[] = [
  ...
  mockPreset("aionly", "AiOnly", "AiOnly multi-model OpenAI-compatible relay gateway.", "AIONLY_API_KEY", mockProviderTemplate({ name: "aionly", kind: "openai", baseUrl: "https://api.aionly.com/v1", models: mockAiOnlyModels, default: "deepseek-v4-pro", apiKeyEnv: "AIONLY_API_KEY", contextWindow: 128000, modelOverrides: [{ model: "deepseek-v4-pro", reasoningProtocol: "deepseek", supportedEfforts: ["disabled", "high", "max"], defaultEffort: "high" }, { model: "deepseek-v4-flash", reasoningProtocol: "deepseek", supportedEfforts: ["disabled", "high", "max"], defaultEffort: "high" }] })),
];
