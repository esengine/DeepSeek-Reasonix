...
const mockModelScopeModels = ["Qwen/Qwen3.5-397B-A17B", "Qwen/Qwen3.5-122B-A10B", "Qwen/Qwen3.5-27B", "deepseek-ai/DeepSeek-V4-Flash-0731", "deepseek-ai/DeepSeek-V4-Pro", "MiniMax/MiniMax-M3", "ZhipuAI/GLM-5.2"];
...
const mockProviderPresetTemplates: MockProviderPresetTemplate[] = [
  ...
  mockPreset("modelscope", "ModelScope", "ModelScope community OpenAI-compatible endpoint with Qwen, DeepSeek and other open-source models.", "MODELSCOPE_API_KEY", mockProviderTemplate({ name: "modelscope", kind: "openai", baseUrl: "https://api-inference.modelscope.cn/v1", models: mockModelScopeModels, default: "Qwen/Qwen3.5-397B-A17B", apiKeyEnv: "MODELSCOPE_API_KEY" })),
