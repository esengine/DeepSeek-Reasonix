...
const mockProviderPresetTemplates: MockProviderPresetTemplate[] = [
  ...
  mockPreset("scnet", "SCNet", "SCNet (National Supercomputing Internet) OpenAI-compatible token-plan API.", "SCNET_API_KEY", mockProviderTemplate({ name: "scnet", kind: "openai", baseUrl: "https://api.scnet.cn/api/llm/v1", modelsUrl: "https://api.scnet.cn/api/llm/v1/models", models: ["MiniMax-M2.5", "qwen3.7-plus", "qwen3.5-plus", "DeepSeek-R1-Distill-Qwen-7B", "QwQ-32B"], default: "MiniMax-M2.5", apiKeyEnv: "SCNET_API_KEY" })),
  mockPreset("scnet-anthropic", "SCNet Anthropic", "SCNet (National Supercomputing Internet) Anthropic-compatible token-plan endpoint with Bearer auth.", "SCNET_API_KEY", mockProviderTemplate({ name: "scnet-anthropic", kind: "anthropic", baseUrl: "https://api.scnet.cn/api/llm/anthropic", modelsUrl: "https://api.scnet.cn/api/llm/v1/models", models: ["MiniMax-M2.5", "qwen3.7-plus", "qwen3.5-plus", "DeepSeek-R1-Distill-Qwen-7B", "QwQ-32B"], default: "MiniMax-M2.5", apiKeyEnv: "SCNET_API_KEY", authHeader: true, thinking: "adaptive" })),
];
