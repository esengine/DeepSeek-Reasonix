...
function makeMockApp(): AppBindings {
  ...
  const mockOfficialThemeAssets = {
    "official-semantix": {
      previewUrl: new URL("../../../themes/official/official-semantix/preview.webp", import.meta.url).href,
      backgroundUrl: new URL("../../../themes/official/official-semantix/background.webp", import.meta.url).href,
    },
    "official-rose-dawn": {
  ...
  let mockThemePacks: import("./themePack").ThemePackView[] = [
    ...
    { ...mockOfficialThemeAssets["official-semantix"], id: "official-semantix", name: "Semantix Design", author: "Reasonix Contributors", license: "MIT", baseStyle: "carbon", builtin: true, kind: "official", active: false, hasBackground: true, nameKey: "settings.themes.official.official-semantix.name", descriptionKey: "settings.themes.official.official-semantix.description", tokens: { light: { bg: "#F3F8F6", fg: "#172A24", accent: "#216F5F", ok: "#277A60", warn: "#8B5B13", err: "#B1494B" }, dark: { bg: "#0B1210", fg: "#EAF4F0", accent: "#2F967F", ok: "#56B88E", warn: "#D5A657", err: "#E0696A" } }, recipes: { density: "comfortable", corners: "soft" }, background: { focusX: 0.76, focusY: 0.5, safeArea: "left", homeOpacity: 0.94, taskOpacity: 0.18, overlayStrength: 0.74, paneOpacity: 0.50 } },
