...
assert(!imageInputHardBlocked("https://api.deepseek.com", "deepseek-v4-flash"), "no SKU hard-list — the backend hard-limit preview and the user's override decide");
assert(!imageInputHardBlocked("https://eu.deepseek.com/anthropic", "future-vision"), "unknown/future models are not hard-blocked by name");
