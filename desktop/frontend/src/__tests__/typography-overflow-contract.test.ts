...
eq(finalDeclaration(".provider-model-draft__option", "display"), "grid", "provider model cards use explicit internal rows");
eq(finalDeclaration(".provider-model-draft__option", "grid-template-rows"), "var(--provider-model-name-slot-size) auto auto", "provider model cards reserve name, vision, and context rows");
eq(finalDeclaration(".provider-model-draft__option", "content-visibility"), "auto", "provider model cards retain offscreen culling");
eq(finalDeclaration(".provider-model-draft__option", "contain-intrinsic-size"), "auto 48px", "refresh model cards retain their compact intrinsic estimate");
eq(finalDeclaration(".provider-model-draft--inline .provider-model-draft__option", "contain-intrinsic-size"), "auto calc(var(--provider-model-name-slot-size) + 56px)", "context model cards use an intrinsic estimate that includes their controls");
...
eq(finalDeclaration(".provider-model-draft__model-name", "block-size"), "var(--provider-model-name-slot-size)", "provider model names reserve a stable two-line slot");
eq(finalDeclaration(".provider-model-draft__model-name", "line-height"), "1.35", "provider model name slot follows the existing compact line height");
eq(finalDeclaration(".provider-model-draft__model-name", "-webkit-line-clamp"), "2", "provider model names clamp after two lines");
eq(finalDeclaration(".provider-model-draft__model-name", "overflow"), "hidden", "provider model names clip beyond their two-line slot");
eq(finalDeclaration(".provider-model-draft__model-name", "overflow-wrap"), "anywhere", "provider model names still wrap arbitrary identifiers inside the slot");
eq(finalDeclaration(".provider-model-draft__model", "align-items"), "start", "model checkbox stays aligned to the first name line");
