...
import { MCPServersSettingsPage, PluginsSettingsPage, activeWorkBusyNoticeText, failureKind, mcpServerDraftJSON, parseMCPQuickDefinition, parseMCPServerJSON, summarizeServerError, withExplicitMCPClears } from "../components/CapabilitiesPanel";
