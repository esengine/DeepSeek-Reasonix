export const zhCN = {
  ...
  settings: {
    ...
    preset: {
      label: "预设",
      auto: "auto — flash 基线，困难时自动升级为 pro",
      autoDesc: "auto — flash 基线；困难轮次自动升级为 pro",
      flash: "flash — 始终使用 flash，不自动升级",
      flashDesc: "flash — 始终 flash；不自动升级",
      pro: "pro — 始终使用 pro",
      proDesc: "pro — 始终 pro；约 3 倍 flash 成本",
    },
    ...
    activeModel: "当前模型",
    model: "模型",
    modelAutoDesc: "Auto — 困难轮次自动升级为 pro",
