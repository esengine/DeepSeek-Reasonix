// Package netclient builds HTTP clients and proxy resolvers that share QiaotongAgent's
...
import (
	...
	"qiaotongagent/internal/sysproxy"
)
...
// NewHTTPClient returns an HTTP client with QiaotongAgent proxy settings applied.
