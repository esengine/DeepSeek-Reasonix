...
func TestBuiltinsRegistered(t *testing.T) {
	want := []string{"bash", "code_index", "edit_file", "glob", "grep", "ls", "move_file", "multi_edit", "read_file", "regex_replace", "web_fetch", "write_file"}
...
func TestBuiltinReadOnlyClassification(t *testing.T) {
	readOnly := map[string]bool{
		...
		"write_file": false, "edit_file": false, "multi_edit": false, "move_file": false, "regex_replace": false, "bash": false,
	}
