...
// `qiaotongagent acp` command) implements it by reusing setup()'s assembly: a
...
// point the `qiaotongagent acp` command calls.
//
...
// sessionSetConfigOption applies ACP's generic session-level selector. QiaotongAgent
