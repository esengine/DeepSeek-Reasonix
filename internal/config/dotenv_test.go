...
// TestLoadDotEnvReadsGlobalCredentials proves `qiaotongagent setup`'s target — the
// qiaotongagent-owned credentials file in the user config dir — is loaded from any
