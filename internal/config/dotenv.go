...
// takes precedence), then the qiaotongagent-owned global credentials file in the user
// config dir (where `qiaotongagent setup` writes keys, so they resolve from any
