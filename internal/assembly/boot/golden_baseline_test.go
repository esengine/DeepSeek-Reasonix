...
// regenerate with:
//
//	REASONIX_UPDATE_GOLDEN=1 go test ./internal/assembly/boot -run TestGoldenBaseline -count=1
//
...
// labels, and probe output; internal/platform/environment covers it with its own
