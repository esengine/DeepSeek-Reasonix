...
var Chinese = Messages{
	...
	TrayOpen:           "打开 Reasonix Studio",
	TrayCloseToTray:    "关掉窗口也继续跑",
	TrayQuit:           "退出 Reasonix",
	TrayIdle:           "没有在跑的",
	TrayWorking:        "%d 个在跑",
	TrayAttention:      "%d 个在等你",
	TrayJobs:           "%d 个后台任务在跑",
	...
	ReceiptUnverifiedHeader: "这一轮自己说明的:",
	ReceiptMore:             "另有 %d 项",
	...
	NoSessionToResumeStartingNew: "没有可恢复的会话 — 开一个新的会话",
	ResumeRequiresTTY:            "--resume 需要交互式终端；用 --continue 直接恢复最近一次",
	PickSessionLabel:             "恢复哪个会话？",
	AmbiguousResumeHint:          "用上面的某个 id 重新运行 `--resume <id>`",
	...
	ImagesUnfit:                  "有 %d 张附件没有发出去，因为任何模型都不会接收它：%s",
	...
	WorkModeListHint:             "使用 /preset balanced|delivery 切换（/work-mode、/profile 为兼容别名）",
	...
	WorkModeDeprecatedNotice:     "提示：/work-mode 与 /profile 已弃用，请使用 /preset balanced|delivery",
	RewindNone:                   "暂无可回滚的内容",
	...
	ProtocolChooseLabel:   "这个地址按哪种协议驱动？",
	ProtocolOpenAIName:    "OpenAI Chat Completions",
	ProtocolOpenAIDesc:    "最常见的那条线；这条线上供应商不跑联网搜索",
	ProtocolResponsesName: "OpenAI Responses",
	ProtocolResponsesDesc: "无状态；联网搜索由供应商自己跑",
	ProtocolAnthropicName: "Anthropic Messages",
	ProtocolAnthropicDesc: "联网搜索由供应商自己跑",
...
用法：
  reasonix [--model NAME] [-c|--continue] [-r|--resume [QUERY]] [--permission-mode MODE] [--effort LEVEL] [--add-dir PATH]   交互式会话（终端界面，同 reasonix tui）
