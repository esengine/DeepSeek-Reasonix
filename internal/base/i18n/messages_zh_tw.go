...
var ChineseTraditional = Messages{
	...
	TrayOpen:           "打開 Reasonix Studio",
	TrayCloseToTray:    "關掉視窗也繼續跑",
	TrayQuit:           "離開 Reasonix",
	TrayIdle:           "沒有在跑的",
	TrayWorking:        "%d 個在跑",
	TrayAttention:      "%d 個在等你",
	TrayJobs:           "%d 個背景工作在跑",
	...
	ApprovalChoiceHint:              "↑/↓ 選擇 · Enter 確認 · y/a/p/n 快速鍵",
	...
	NotifyTitle:                     "Reasonix",
	NotifyTurnDone:                  "這一輪結束了",
	...
	EgressApprovalReasonFmt:         "一條 bash 命令要存取 %s，它不在 [sandbox] allowed_domains 中。是否允許？",
	...
	WorkModeListHint:             "使用 /preset balanced|delivery 切換（/work-mode、/profile 為相容別名）",
	...
	WorkModeUsage:                "用法：/preset balanced|delivery",
	...
	WorkModeDeprecatedNotice:     "提示：/work-mode 與 /profile 已棄用，請使用 /preset balanced|delivery",
	RewindNone:                   "暫無可回滾的內容",
  ...
  reasonix report delete [ID]     不傳送，直接刪除本機報告`,
	...
	StandaloneConsoleHint: "這是 Reasonix 命令列工具，需要在 PowerShell 等終端機裡執行。\n要使用桌面應用程式，請安裝 Reasonix Studio（ReasonixStudio-windows-amd64-installer.exe）：\n  https://github.com/esengine/DeepSeek-Reasonix/releases?q=studio-v&expanded=true\n\n按 Enter 關閉此視窗。\n",
	UsageBody: `reasonix — 由設定和插件驅動的 coding agent（多模型）

用法：
  reasonix [--model NAME] [-c|--continue] [-r|--resume [QUERY]] [--permission-mode MODE] [--effort LEVEL] [--add-dir PATH]   互動式會話（終端介面，同 reasonix tui）
