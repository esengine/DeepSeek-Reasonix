...
skill/suggestion/accept research/status research/list research/findings research/evidence/record`)
	...
	if requests != 68 || notifications != 3 {
		t.Fatalf("directions = %d requests/%d notifications", requests, notifications)
	}
}
