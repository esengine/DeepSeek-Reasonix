...
var English = Messages{
	...
	SetupAddAccount:          "Add account",
	SetupAddAccountDesc:      "Add another API key for a curated provider family",
	SetupAccountLabel:        "Account label",
	SetupAccountRename:       "Rename account",
	SetupAccountToggle:       "Enable/disable account",
	SetupAccountRetire:       "Retire account",
	SetupProjectNoAccounts:   "Project setup can only use existing global accounts",
