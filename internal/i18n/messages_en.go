...
var English = Messages{
	...
	SlashHelp:          "commands: /compact · /new · /resume · /rewind · /tree · /branch · /switch · /todo · /verbose · /thinking · /model (switch model) · /mcp · /skill · /hooks · /paste-image · /memory · /quit · /help · plus skills (/init, /explore, …)",
	...
	ThinkingUnsupported:    "thinking effort is only supported for DeepSeek providers",
	ThinkingUsage:          "usage: /thinking high|max|off",
	ThinkingCurrentFmt:     "thinking effort for %s: %s",
	ThinkingSettingFmt:     "setting thinking effort for %s to %s…",
	ThinkingSetDoneFmt:     "thinking effort for %s set to %s",
