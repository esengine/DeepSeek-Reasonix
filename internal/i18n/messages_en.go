...
var English = Messages{
	...
	ChatStatusNextJobLabel:                 "NEXT JOB",
	LoopStatusNone:                         "none",
	LoopStatusCurrentFmt:                   "NEXT JOB indicator: %s",
	LoopStatusSetOn:                        "NEXT JOB indicator always shown — /loopstatus off or auto to change",
	LoopStatusSetOff:                       "NEXT JOB indicator hidden — /loopstatus on or auto to change",
	LoopStatusSetAuto:                      "NEXT JOB indicator auto — shown only while a scheduled task is pending",
	LoopStatusUnknownFmt:                   "unknown /loopstatus mode %q — use on, off, or auto",
