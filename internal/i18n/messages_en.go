...
var English = Messages{
	...
	CmdSubagents:               "open the subagent task center",
	...
	ArgSubagentsCancel:         "cancel a running subagent",
	ArgSubagentsClear:          "clear retained terminal runs",
	ArgSubagentsClearCompleted: "clear completed runs",
	ArgSubagentsClearFailed:    "clear failed runs",
	ArgSubagentsClearCanceled:  "clear canceled runs",
	ArgSubagentsClearAll:       "clear all retained runs",
	...
	SubagentsUsageCancel:          "usage: /subagents cancel <id-or-alias>",
	SubagentsUsageClear:           "usage: /subagents clear [completed|failed|canceled|all]",
	SubagentsUsage:                "usage: /subagents [cancel <id-or-alias>|clear [completed|failed|canceled|all]]",
	SubagentNotFoundFmt:           "subagent not found: %s",
	SubagentCanceledFmt:           "canceled subagent %s",
	SubagentsClearedFmt:           "cleared %s subagents",
	SubagentsClearedAll:           "cleared all retained subagents",
	SubagentsNone:                 "no active or recent subagents",
	SubagentsTextHeaderFmt:        "subagents (%d)",
	SubagentsShowingFmt:           "showing %d of %d",
	SubagentsWindowFmt:            "  showing %d-%d of %d",
	SubagentsFilterLabel:          "filter: ",
	SubagentsFilterEditLabel:      "filter> ",
	SubagentsFilterPlaceholder:    "type to filter alias / skill / state",
	SubagentsNoMatch:              "no matching subagents",
	SubagentsFilterExitHint:       "type to filter · Enter done · Esc stop filtering",
	SubagentsFilterIdleHint:       "/ filter · ↑/↓ move · Enter detail · c cancel · r refresh · Esc close",
	SubagentsFilterEditingHint:    "type to filter · Enter done · Backspace edit · Esc stop filtering",
	SubagentIDFmt:                 "id %s",
	SubagentStartedUnknown:        "started unknown",
	SubagentStartedFmt:            "started %s",
	SubagentStartedEndedFmt:       "started %s · ended %s",
	SubagentErrorFmt:              "error %s",
	SubagentStateRunning:          "running",
	SubagentStateCompleted:        "completed",
	SubagentStateFailed:           "failed",
	SubagentStateCanceled:         "canceled",
	SubagentStateUnknown:          "unknown",
	SubagentNoticeCompleted:       "completed; final answer below",
	SubagentCanceledByUser:        "canceled by user",
	SubagentsClearAllLabel:        "all retained",
	SubagentNoEvents:              "no recorded child events yet",
	SubagentThinkingLabel:         "thinking",
	SubagentAnswerLabel:           "answer",
	SubagentToggleExpand:          "Ctrl-O expand",
	SubagentToggleCollapse:        "Ctrl-O collapse",
	SubagentWaitingForActivity:    "waiting for child activity...",
	SubagentLinesOmittedFmt:       "  ... %d lines omitted ...",
	SubagentDetailScrollFooterFmt: "↑/↓ scroll · PgUp/PgDn · Home/End · %d/%d · Esc close",
	SubagentDetailCancelSuffix:    " · c cancel",
	SubagentDetailCloseCancelHint: "Esc close · c cancel",
	SubagentDetailCloseHint:       "Esc close",
