...
var English = Messages{
	...
	SlashHelp:          "commands: /compact · /new · /resume · /rewind · /tree · /branch · /switch · /todo · /verbose · /model (switch model) · /mcp · /skill · /hooks · /paste-image · /memory · /quit · /help · plus skills (/init, /explore, …)",
	...
	FetchModelsFailedFmt:    "Failed to fetch models for %s: %v (using presets)",
	SelectModelsLabel:       "Select models to enable for %s",
	FetchModelsUsingPresets: "Using preset models (API unavailable)",
	SelectProvidersReveal:   "Press / for more providers",
	BillingModeLabel:        "Select %s billing mode",
	BillingModeTP:           "Token Plan (subscription)",
	BillingModePPU:          "Pay Per Use (per-token)",
	MiMoTPDetected:          "Detected Token Plan API key (tp- prefix)",
	MiMoPPUDetected:         "Detected Pay Per Use API key (sk- prefix)",
