...
var English = Messages{
	...
	WorkModeUsage:                "usage: /preset <light|balanced|delivery> (deprecated and ignored)",
	WorkModeDeprecatedNotice:     "Reasonix now uses one adaptive standard execution: planning, verification, and review strength follow task risk automatically. Execution modes are no longer switchable; /preset is accepted for compatibility and ignored.",
