...
var ChineseTraditional = Messages{
	...
	ChatStatusNextJobLabel:                 "下次任務",
	LoopStatusNone:                         "無",
	LoopStatusCurrentFmt:                   "NEXT JOB 指示器：%s",
	LoopStatusSetOn:                        "NEXT JOB 指示器始終顯示——用 /loopstatus off 或 auto 更改",
	LoopStatusSetOff:                       "NEXT JOB 指示器已隱藏——用 /loopstatus on 或 auto 更改",
	LoopStatusSetAuto:                      "NEXT JOB 指示器自動——僅在有待觸發的排定任務時顯示",
	LoopStatusUnknownFmt:                   "未知的 /loopstatus 模式 %q——請用 on、off 或 auto",
