...
var ChineseTraditional = Messages{
	...
	ArgSubagentsCancel:         "取消一個執行中的子代理",
	ArgSubagentsClear:          "清理已保留的終態子代理",
	ArgSubagentsClearCompleted: "清理已完成的執行",
	ArgSubagentsClearFailed:    "清理已失敗的執行",
	ArgSubagentsClearCanceled:  "清理已取消的執行",
	ArgSubagentsClearAll:       "清理所有已保留的終態執行",
	ArgModelCurrent:            "當前",
	...
	SubagentsUsageCancel:          "用法：/subagents cancel <id-or-alias>",
	SubagentsUsageClear:           "用法：/subagents clear [completed|failed|canceled|all]",
	SubagentsUsage:                "用法：/subagents [cancel <id-or-alias>|clear [completed|failed|canceled|all]]",
	SubagentNotFoundFmt:           "未找到子代理：%s",
	SubagentCanceledFmt:           "已取消子代理 %s",
	SubagentsClearedFmt:           "已清理 %s 狀態的子代理",
	SubagentsClearedAll:           "已清理所有已保留的終態子代理",
	SubagentsNone:                 "目前沒有執行中或最近保留的子代理",
	SubagentsTextHeaderFmt:        "子代理（%d）",
	SubagentsShowingFmt:           "顯示 %d / %d",
	SubagentsWindowFmt:            "  顯示 %d-%d / %d",
	SubagentsFilterLabel:          "過濾：",
	SubagentsFilterEditLabel:      "過濾> ",
	SubagentsFilterPlaceholder:    "依別名 / 技能 / 狀態過濾",
	SubagentsNoMatch:              "沒有匹配的子代理",
	SubagentsFilterExitHint:       "輸入過濾詞 · Enter 完成 · Esc 退出過濾",
	SubagentsFilterIdleHint:       "/ 過濾 · ↑/↓ 移動 · Enter 詳情 · c 取消 · r 重新整理 · Esc 關閉",
	SubagentsFilterEditingHint:    "輸入過濾詞 · Enter 完成 · Backspace 刪除 · Esc 退出過濾",
	SubagentIDFmt:                 "id %s",
	SubagentStartedUnknown:        "開始時間未知",
	SubagentStartedFmt:            "開始於 %s",
	SubagentStartedEndedFmt:       "開始於 %s · 結束於 %s",
	SubagentErrorFmt:              "錯誤：%s",
	SubagentStateRunning:          "執行中",
	SubagentStateCompleted:        "已完成",
	SubagentStateFailed:           "已失敗",
	SubagentStateCanceled:         "已取消",
	SubagentStateUnknown:          "未知",
	SubagentNoticeCompleted:       "已完成；最終答覆如下",
	SubagentCanceledByUser:        "使用者已取消",
	SubagentsClearAllLabel:        "所有已保留的終態",
	SubagentNoEvents:              "目前還沒有記錄到子代理事件",
	SubagentThinkingLabel:         "思考",
	SubagentAnswerLabel:           "答覆",
	SubagentToggleExpand:          "Ctrl-O 展開",
	SubagentToggleCollapse:        "Ctrl-O 收起",
	SubagentWaitingForActivity:    "等待子代理活動中...",
	SubagentLinesOmittedFmt:       "  ... 省略了 %d 行 ...",
	SubagentDetailScrollFooterFmt: "↑/↓ 捲動 · PgUp/PgDn · Home/End · %d/%d · Esc 關閉",
	SubagentDetailCancelSuffix:    " · c 取消",
	SubagentDetailCloseCancelHint: "Esc 關閉 · c 取消",
	SubagentDetailCloseHint:       "Esc 關閉",
