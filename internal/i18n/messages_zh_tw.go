...
var ChineseTraditional = Messages{
	...
	WorkModeUsage:                "用法：/preset <light|balanced|delivery>（已棄用並忽略）",
	WorkModeDeprecatedNotice:     "Reasonix 已改用自適應標準執行：規劃、驗證與復查強度隨任務風險自動調整。執行模式已不可切換；/preset 僅作相容接受，不產生任何效果。",
	RewindNone:                   "暫無可回滾的內容",
