...
var ChineseTraditional = Messages{
	...
	SetupAddAccount:          "新增帳號",
	SetupAddAccountDesc:      "為既有供應商族新增另一把 API Key",
	SetupAccountLabel:        "帳號名稱",
	SetupAccountRename:       "重新命名帳號",
	SetupAccountToggle:       "啟用/停用帳號",
	SetupAccountRetire:       "退休帳號",
	SetupProjectNoAccounts:   "專案級 setup 只能選擇既有全域帳號",
