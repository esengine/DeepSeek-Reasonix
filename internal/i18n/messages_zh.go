...
var Chinese = Messages{
	...
	SetupAddAccount:          "添加账号",
	SetupAddAccountDesc:      "为已有供应商族添加另一把 API Key",
	SetupAccountLabel:        "账号名称",
	SetupAccountRename:       "重命名账号",
	SetupAccountToggle:       "启用/停用账号",
	SetupAccountRetire:       "退休账号",
	SetupProjectNoAccounts:   "项目级 setup 只能选择已有全局账号",
