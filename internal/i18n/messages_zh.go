...
var Chinese = Messages{
	...
	ArgSubagentsCancel:         "取消一个运行中的子代理",
	ArgSubagentsClear:          "清理已保留的终态子代理",
	ArgSubagentsClearCompleted: "清理已完成的运行",
	ArgSubagentsClearFailed:    "清理已失败的运行",
	ArgSubagentsClearCanceled:  "清理已取消的运行",
	ArgSubagentsClearAll:       "清理所有已保留的终态运行",
	ArgModelCurrent:            "当前",
	...
	SubagentsClearedFmt:           "已清理 %s 状态的子代理",
	SubagentsClearedAll:           "已清理所有已保留的终态子代理",
	SubagentsNone:                 "当前没有运行中或最近保留的子代理",
	SubagentsTextHeaderFmt:        "子代理（%d）",
	SubagentsShowingFmt:           "显示 %d / %d",
	SubagentsWindowFmt:            "  显示 %d-%d / %d",
	SubagentsFilterLabel:          "过滤：",
	SubagentsFilterEditLabel:      "过滤> ",
	SubagentsFilterPlaceholder:    "按别名 / 技能 / 状态过滤",
	SubagentsNoMatch:              "没有匹配的子代理",
	SubagentsFilterExitHint:       "输入过滤词 · Enter 完成 · Esc 退出过滤",
	SubagentsFilterIdleHint:       "/ 过滤 · ↑/↓ 移动 · Enter 详情 · c 取消 · r 刷新 · Esc 关闭",
	SubagentsFilterEditingHint:    "输入过滤词 · Enter 完成 · Backspace 删除 · Esc 退出过滤",
	SubagentIDFmt:                 "id %s",
	SubagentStartedUnknown:        "开始时间未知",
	SubagentStartedFmt:            "开始于 %s",
	SubagentStartedEndedFmt:       "开始于 %s · 结束于 %s",
	SubagentErrorFmt:              "错误：%s",
	SubagentStateRunning:          "运行中",
	SubagentStateCompleted:        "已完成",
	SubagentStateFailed:           "已失败",
	SubagentStateCanceled:         "已取消",
	SubagentStateUnknown:          "未知",
	SubagentNoticeCompleted:       "已完成；最终答复如下",
	SubagentCanceledByUser:        "用户已取消",
	SubagentsClearAllLabel:        "所有已保留的终态",
	SubagentNoEvents:              "当前还没有记录到子代理事件",
	SubagentThinkingLabel:         "思考",
	SubagentAnswerLabel:           "答复",
	SubagentToggleExpand:          "Ctrl-O 展开",
	SubagentToggleCollapse:        "Ctrl-O 收起",
	SubagentWaitingForActivity:    "等待子代理活动中...",
	SubagentLinesOmittedFmt:       "  ... 省略了 %d 行 ...",
	SubagentDetailScrollFooterFmt: "↑/↓ 滚动 · PgUp/PgDn · Home/End · %d/%d · Esc 关闭",
	SubagentDetailCancelSuffix:    " · c 取消",
	SubagentDetailCloseCancelHint: "Esc 关闭 · c 取消",
	SubagentDetailCloseHint:       "Esc 关闭",
