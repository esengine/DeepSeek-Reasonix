...
var Chinese = Messages{
	...
	ChatStatusIdle:         "Tab 切换 plan · Ctrl-O 显示/隐藏思考过程 · Enter 发送 · Esc 退出当前状态 · PgUp/PgDn 滚动 · Ctrl-D 退出",
	...
	SlashHelp:          "命令：/compact · /new · /resume · /rewind · /tree · /branch · /switch · /todo · /verbose · /thinking · /model（切换模型）· /mcp · /skill · /hooks · /paste-image · /memory · /quit · /help · 以及 skills（/init、/explore …）",
	...
	ThinkingUnsupported:    "只有 DeepSeek provider 支持设置思考强度",
	ThinkingUsage:          "用法：/thinking high|max|off",
	ThinkingCurrentFmt:     "%s 的思考强度：%s",
	ThinkingSettingFmt:     "正在将 %s 的思考强度设置为 %s…",
	ThinkingSetDoneFmt:     "已将 %s 的思考强度设置为 %s",
	RewindNone:             "暂无可回滚的内容",
