...
var Chinese = Messages{
	...
	ChatStatusNextJobLabel:                 "下次任务",
	LoopStatusNone:                         "无",
	LoopStatusCurrentFmt:                   "NEXT JOB 指示器：%s",
	LoopStatusSetOn:                        "NEXT JOB 指示器始终显示——用 /loopstatus off 或 auto 更改",
	LoopStatusSetOff:                       "NEXT JOB 指示器已隐藏——用 /loopstatus on 或 auto 更改",
	LoopStatusSetAuto:                      "NEXT JOB 指示器自动——仅在有待触发的排定任务时显示",
	LoopStatusUnknownFmt:                   "未知的 /loopstatus 模式 %q——请用 on、off 或 auto",
