...
<header><a class="brand" href="https://qiaotongagent.io">${LOGO}</a><a class="brand" href="https://qiaotongagent.io">QiaotongAgent</a><span class="crumb">/ ${esc(crumb)}</span>${LANG_SWITCH}${nav ? `<span class="nav">${nav}</span>` : ""}</header>
