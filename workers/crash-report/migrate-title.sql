-- One-time: add the crash-group summary column to the live qiaotongagent-crash DB.
-- Apply once: wrangler d1 execute qiaotongagent-crash --remote --file=migrate-title.sql
